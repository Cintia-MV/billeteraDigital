...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Crear los usuarios
        Usuario.crearUsuario(cantidadUsuarios, scan, usuarios);

        // Mostrar usuarios creados
        Usuario.mostrarUsuarios(usuarios);

        // Seleccionar un usuario
        System.out.println("\nSeleccione el número de cuenta del usuario: ");
        int seleccionUsuario = Integer.parseInt(scan.nextLine());

        Usuario usuarioSeleccionado = Usuario.buscarUsuario(usuarios, seleccionUsuario);



        // Verificar si se encontró el usuario seleccionado
                ...
                try {
                    ...
                    switch (opcion) {
                        ...
                        case 1:
                            ...
                            System.out.println("Cliente: "+usuarioSeleccionado.getNombre());
                            System.out.println("Número de cuenta: "+usuarioSeleccionado.getNroCuenta());
                            System.out.println("El saldo disponible es: " + usuarioSeleccionado.getWallet().obtenerSaldo());
                            break;
                        case 2:
                            ...
                            usuarioSeleccionado.getWallet().depositar(cantidad); //Llamada al método
                            break;
                        ...
                        case 3:
                            ...
                            usuarioSeleccionado.getWallet().retirarSaldo(cantidad);
                            break;
                        ...
                        case 4:
                            ...
                            cantidad = Double.parseDouble(cantidadString);
                            usuarioSeleccionado.getWallet().convertirMoneda(cantidad, "CLP");
                            break;
                        ...
                        case 5:
                            ...
                            System.out.println("Cliente: "+usuarioSeleccionado.getNombre());
                            System.out.println("Número de cuenta: "+usuarioSeleccionado.getNroCuenta());
                            List<String> historial = usuarioSeleccionado.getWallet().obtenerTransacciones();
